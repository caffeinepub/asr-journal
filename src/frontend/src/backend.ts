...
export class Backend implements backendInterface {
    ...
    async saveJournalEntry(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: ArtCanvas): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveJournalEntry(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
